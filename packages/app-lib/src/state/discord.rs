...
impl DiscordGuard {
    ...
    pub async fn force_set_activity(
        ...
        let build_info = format!("Quantum • v{}", launcher.version);
        let build_download = "https://github.com/ivanmaspa/Quantum-Launcher";
        ...
        let activity = Activity::new()
            ...
            .assets(
                Assets::new()
                    .large_image("quantum_logo")
                    .large_text(&build_info)
                    .small_image("quantum_logo")
