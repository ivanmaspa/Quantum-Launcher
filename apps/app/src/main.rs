...
async fn initialize_state(app: tauri::AppHandle) -> api::Result<()> {
    ...
    State::init().await?;
    tracing::info!("Quantum Launcher state successfully initialized.");
...
fn main() {
    ...
    */
    ...
    tracing::info!("Initialized tracing subscriber. Loading Quantum Launcher!");
