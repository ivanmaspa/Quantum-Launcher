...
export const launcherUrl = 'https://github.com/ivanmaspa/Quantum-Launcher/releases'

const os = ref('')
const releaseLink = `https://api.github.com/repos/ivanmaspa/Quantum-Launcher/releases/latest`
const branchesLink = `https://api.github.com/repos/ivanmaspa/Quantum-Launcher/branches`
