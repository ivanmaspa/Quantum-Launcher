<template>
  <div class="action-groups">
    ...
    <ModalWrapper ref="confirmUpdate" :has-to-type="false" header="Request to update the Quantum Launcher">
      <div class="modal-body">
        <div class="markdown-body">
          <p>The new version of the Quantum Launcher is available.</p>
