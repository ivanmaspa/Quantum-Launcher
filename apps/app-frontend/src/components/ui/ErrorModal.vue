...
defineExpose({
  async show(errorVal, context, canClose = true, source = null) {
    ...
    if (errorVal.message && errorVal.message.includes('Minecraft authentication error:')) {
      ...
      title.value = 'Error initializing Quantum Launcher'
      ...
      <div class="markdown-body">
        <template v-if="errorType === 'minecraft_auth'">
          <template v-if="metadata.network">
            ...
            <p>
              It looks like there were issues with the Quantum Launcher connecting to Microsoft's
          ...
          <template v-else-if="metadata.hostsFile">
            <h3>Network issues</h3>
            <p>
              The Quantum Launcher tried to connect to Microsoft / Xbox / Minecraft services, but the
        ...
        <template v-if="errorType === 'directory_move'">
          <template v-if="metadata.readOnly">
            ...
            <p>
              It looks like the Quantum Launcher is unable to write to the directory you selected.
          ...
          <template v-else>
            <p>
              The Quantum Launcher is unable to migrate to the new directory you selected. Please
        ...
        <template v-else-if="errorType === 'state_init'">
          <p>
            Quantum Launcher failed to load correctly. This may be because of a corrupted file, or
        ...
        <template v-else-if="errorType === 'no_loader_version'">
          <p>The Quantum Launcher failed to find the loader version for this instance.</p>
